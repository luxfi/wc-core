...
const wc_socket_transport_1 = tslib_1.__importDefault(require("@luxwallet/wc-socket-transport"));
...
class Connector {
    constructor(opts) {
        ...
        this._clientMeta = (0, wc_utils_1.getClientMeta)() || opts.connectorOpts.clientMeta || null;
        this._cryptoLib = opts.cryptoLib;
        this._sessionStorage = opts.sessionStorage || new storage_1.default(opts.connectorOpts.storageId);
        this._qrcodeModal = opts.connectorOpts.qrcodeModal;
        this._qrcodeModalOptions = opts.connectorOpts.qrcodeModalOptions;
        this._signingMethods = [...wc_utils_1.signingMethods, ...(opts.connectorOpts.signingMethods || [])];
        ...
        this._transport =
            opts.transport ||
                new wc_socket_transport_1.default({
    ...
    set key(value) {
        ...
        const key = (0, wc_utils_1.convertHexToArrayBuffer)(value);
        this._key = key;
    }
    get key() {
        if (this._key) {
            const key = (0, wc_utils_1.convertArrayBufferToHex)(this._key, true);
            return key;
        }
        return "";
    }
    ...
    get clientId() {
        ...
        if (!clientId) {
            clientId = this._clientId = (0, wc_utils_1.uuid)();
        }
    ...
    get clientMeta() {
        ...
        if (!clientMeta) {
            clientMeta = this._clientMeta = (0, wc_utils_1.getClientMeta)();
        }
        return clientMeta;
    }
    set peerMeta(value) {
    ...
    createInstantRequest(instantRequest) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            this.handshakeTopic = (0, wc_utils_1.uuid)();
    ...
    sendTransaction(tx) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const parsedTx = (0, wc_utils_1.parseTransactionData)(tx);
            const request = this._formatRequest({
    ...
    signPersonalMessage(params) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            params = (0, wc_utils_1.parsePersonalSign)(params);
            const request = this._formatRequest({
    ...
    sendCustomRequest(request, options) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            switch (request.method) {
                ...
                case "eth_chainId":
                    return (0, wc_utils_1.convertNumberToHex)(this.chainId);
                case "eth_sendTransaction":
                case "eth_signTransaction":
                    if (request.params) {
                        request.params[0] = (0, wc_utils_1.parseTransactionData)(request.params[0]);
                    }
                    break;
                case "personal_sign":
                    if (request.params) {
                        request.params = (0, wc_utils_1.parsePersonalSign)(request.params);
                    }
                    break;
                default:
                    break;
    ...
    approveRequest(response) {
        if ((0, wc_utils_1.isJsonRpcResponseSuccess)(response)) {
    ...
    rejectRequest(response) {
        if ((0, wc_utils_1.isJsonRpcResponseError)(response)) {
            const formattedResponse = this._formatResponse(response);
            this._sendResponse(formattedResponse);
        }
        else {
    ...
    _sendRequest(request, options) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const silent = typeof (options === null || options === void 0 ? void 0 : options.forcePushNotification) !== "undefined"
                ...
                : (0, wc_utils_1.isSilentPayload)(callRequest);
            const phase = options === null || options === void 0 ? void 0 : options.phase;
    ...
    _formatRequest(request) {
        ...
        const formattedRequest = {
            id: typeof request.id === "undefined" ? (0, wc_utils_1.payloadId)() : request.id,
            jsonrpc: "2.0",
    ...
    _formatResponse(response) {
        ...
        if ((0, wc_utils_1.isJsonRpcResponseError)(response)) {
            const error = (0, wc_utils_1.formatRpcError)(response.error);
            const errorResponse = Object.assign(Object.assign(Object.assign({}, baseResponse), response), { error });
            return errorResponse;
        }
        else if ((0, wc_utils_1.isJsonRpcResponseSuccess)(response)) {
    ...
    _handleSessionDisconnect(errorMsg) {
        ...
        if (!this._connected) {
            ...
            (0, wc_utils_1.removeLocal)(wc_utils_1.mobileLinkChoiceKey);
        }
        if (this._connected) {
            this._connected = false;
        }
    ...
    _subscribeToSessionResponse(id, errorMsg) {
        this._subscribeToResponse(id, (error, payload) => {
            ...
            if ((0, wc_utils_1.isJsonRpcResponseSuccess)(payload)) {
    ...
    _subscribeToInternalEvents() {
        ...
        this.on("call_request_sent", (error, payload) => {
            ...
            if ((0, wc_utils_1.isMobile)() && this._signingMethods.includes(request.method)) {
                const mobileLinkUrl = (0, wc_utils_1.getLocal)(wc_utils_1.mobileLinkChoiceKey);
                if (mobileLinkUrl) {
    ...
    _initTransport() {
        ...
        this._transport.on("pong", payload => this._eventManager.trigger({ event: "transport_pong", params: [payload] }));
    ...
    _parseUri(uri) {
        const result = (0, wc_utils_1.parseWalletConnectUri)(uri);
